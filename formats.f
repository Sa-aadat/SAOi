...
! SAOi: Selected format conversion modules from the sparsekit project
! SAOi: by Youcef Saad. In the current version csrvbr, csrsss, csrbnd
! SAOi: and csrdia have been deleted. Unused routines have been
! SAOi: commented out, but may be replaced after suitable type
! SAOi: declarations have been added. Used routines have been
! SAOi: modified for type declarations
! SAOi:
...
!----------------------------------------------------------------------c
      ...
      implicit         none
      integer          ja(*),ia(*),nrow,ncol,ndns,ierr,i,j,k
...
!-----------------------------------------------------------------------
      ...
      implicit         none
      integer          ia(*),ja(*),nrow,ncol,ndns,ierr,i,j,k,nzmax,next
      double precision dns(ndns,*),a(*)
!-----------------------------------------------------------------------
...
!-----------------------------------------------------------------------
      ...
      integer          ir(*),jc(*),jao(*),iao(*),nrow,ncol,ndns,ierr
      integer          iad,k0,i,j,k,nnz
!-----------------------------------------------------------------------
...
!-----------------------------------------------------------------------
      ...
      implicit         none
      integer          n,nnz,job,i,j,init,ia(nnz),ja(nnz),iwk(n+1)
      integer          jpos,jnext,k,inext,ipos    
      double precision a(*)
!------------------------------------------------------------------------
...
!-----------------------------------------------------------------------
      ...
      integer          i,j,k,ierr,k1,k2,nrow,job,nzmax,nnz
...
!-----------------------------------------------------------------------
      ...
      integer          ia(*),ja(*),iao(*),jao(*),nrow,ierr,nzmax
      integer          ko,kold,i,j,kdiag,k
...
!-----------------------------------------------------------------------
      ...
      implicit         none
      integer          nrow,nzmax,ierr,i,j,k,ipos,ko,kosav
      integer          lenrow,nnz,kfirst,klast,indu(nrow+1)
      integer          ia(nrow+1),iao(nrow+1),ja(*),jao(nzmax)
      double precision a(*),ao(nzmax)
!-----------------------------------------------------------------------
...
!-----------------------------------------------------------------------
     ...
     *                   ndiag,ierr)
      implicit         none
      integer          k,nnz,k1,k2,ndiag,maxcol,nrow,ncoef,irow,ierr,i,j
...
!-----------------------------------------------------------------------
      ...
      implicit         none
      integer          n,n2,i,j,k,next,ipos,job 
...
c ao      = real array of size nzz containing the "a" part of the transpose
c jao      = integer array of size nnz containing the column indices.
c iao      = integer array of size n2+1 containing the "ia" index array of
c        the transpose.
c
!-----------------------------------------------------------------------
