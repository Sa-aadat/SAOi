...
! SAOi: The l-bfgs-b code by Ciyou Zhu and co-workers
! SAOi: NOTE: the listed routines were cleared by Ciyou Zhu and co-workers
! SAOi: for academic purposes only
! SAOi:

 
c================    L-BFGS-B (version 2.4)   ==========================

      subroutine setulb24(n, m, x, l, u, nbd, f, g, factr, pgtol, wa, 
...
c         dsave(11) = the slope of the flinearch function at
...
c                                open a summary file 'iterate.dat'
            open (10, file = 'iterate.dat', status = 'unknown')
            itfile = 10
         endif
