...
!
      ...
      ne             =  1        !  the number of equality constraints
!
      x(1)           = 1.d0      !  the starting point
      x(2)           = 5.d0
      x(3)           = 5.d0
      x(4)           = 1.d0
!
      ...
      x_lower(4)     = 1.d0
!
      x_upper(1)     = 5.d0     !  the upper bounds
      x_upper(2)     = 5.d0
      x_upper(3)     = 5.d0
      x_upper(4)     = 5.d0
!
      ...
      cname1         = 'HOCK_71'   ! problem name; max 24 characters
!
...
!     xtol           =  1.d-8    ! specify the x-tolerance (Euclidian norm)
!     xtol_inf       =  1.d-10    ! specify the x-tolerance (infinity norm)
...
!     dml_infinity   =  0.002d0    ! the infinity move limit
