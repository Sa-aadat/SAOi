...
! 
      f = 32.d0*x(1)**2 - 16.d0*x(1) + (2.d0*x(1) + x(2) - 1.d0)**2 
     &  + 10.d0*x(3)**2 + 4.d0*x(3)*x(4) - 0.5d0*(2.d0*x(3) 
     &  +  2.d0*x(4))**2
! 
      c(1) = x(4) - 2.d0*x(1) - x(2)
      c(2) = x(2) - 0.5d0*x(3) - 0.5d0*x(4)
      c(3) = 2.d0*x(1) + x(2) - 2.25d0
!
      return
