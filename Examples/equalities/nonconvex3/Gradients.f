...
!
      gf(1)=64.d0*x(1) - 16.d0 + 4.d0*(2.d0*x(1) + x(2) - 1.d0)
      gf(2)=2.d0*(2.d0*x(1) + x(2) - 1.d0)
      gf(3)=20.d0*x(3) + 4.d0*x(4) - 2.d0*(2.d0*x(3) + 2.d0*x(4))
      gf(4)=4.d0*x(3)  - 2.d0*(2.d0*x(3) + 2.d0*x(4)) 
!
      gc(1,1)= -2.d0 
      gc(1,2)= -1.d0     
      gc(1,3)=  0.d0     
