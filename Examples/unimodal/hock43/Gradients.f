...
!
      ...
      gf(4)=2.d0*x(4)+7.d0      
!
      gc(1,1)= 2.d0*x(1)+1.d0   
      gc(1,2)= 2.d0*x(2)-1.d0   
      gc(1,3)= 2.d0*x(3)+1.d0   
      gc(1,4)= 2.d0*x(4)-1.d0   
      gc(2,1)= 2.d0*x(1)-1.d0   
      gc(2,2)= 4.d0*x(2)
      gc(2,3)= 2.d0*x(3)
      gc(2,4)= 4.d0*x(4)-1.d0   
      gc(3,1)= 4.d0*x(1)+2.d0   
      gc(3,2)= 2.d0*x(2)-1.d0   
      gc(3,3)= 2.d0*x(3)
      gc(3,4)=-1.d0      
!
      return
