...
!
      n=21                      !  the number of design variables
      ni=1                      !  the number of inequality constraints
!
      do i=1,11                 !  the starting point
        x(i)=11.d0
      enddo
!
      do i=12,21                !  the starting point
        x(i)=18.d0
      enddo
!
      do i=1,11                 !  the bounds
        x_lower(i)=1.d0
        x_upper(i)=30.d0
      end do
!
      do i=12,21                !  the bounds
        x_lower(i)=1.d0
        x_upper(i)=45.d0
      end do
!
      cname1 = '12-CORNER-POLY'
!
!
