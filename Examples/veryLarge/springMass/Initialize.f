...
!
      n              =  50         !  the number of design variables
...
!
      do i = 1,n
        x_lower(i)   = -5000.d0    !  the lower bounds
      enddo
!
      do i = 1,n
        x_upper(i)   =  5000.d0    !  the upper bounds
      enddo
!
      cname1 = 'SPRING-MASS-VDPTS' ! problem name; max 24 characters
!      
!     multimodal = .true.
!
!
...
!     ftol             = -1.d-10                ! specify the f-tolerance. NOT recommended in general. Values < 0 disable this
      outermax         =  5000000               ! the number of outer loops allowed
!     innermax         =  50                    ! the number of inner loops allowed
      dml_infinity     =  1.d-4                 ! the infinity move limit
