...
!
      cname1 = 'testH8'          ! problem name; max 24 characters
!
!
...
!     finite_diff    =  .true.    ! use finite differences?
      ...
      approx_f       =  1!00       ! select approx_f (see manual)
      approx_c       =  1!00       ! select approx_c (see manual)
!
!
...
!     mayStop        = .false.
      subsolver      =  1! 25        ! specify the solver for the subproblems
...
!     random_start   =  .false.   ! use random starting point?
      biglam         =  1.d4      ! upper bound on the dual variables
      ifalk          =  1
!
