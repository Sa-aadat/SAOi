...
!
      k              =  1         !  problem specific - number of requested eigen values
      p              =  30        !  problem specific - length of each eigen vector column
!
...
!       
      ...
      enddo 
!
      cname1 = 'matstruc4'        ! problem name; max 24 characters
!
!
