...
!
      ...
      x2 = x(2)
!
      gf(1) = 2.d0*(-13.d0 + x1 + ((5.d0 - x2)*x2 -  2.d0)*x2)
     &      + 2.d0*(-29.d0 + x1 + ((x2 + 1.d0)*x2 - 14.d0)*x2)
      gf(2) = 2.d0*(-13.d0 + x1 + ((5.d0 - x2)*x2 -  2.d0)*x2)
     &      * (10.d0*x2 - 3.d0*x2**2 -  2.d0)
     &      + 2.d0*(-29.d0 + x1 + ((x2 + 1.d0)*x2 - 14.d0)*x2)
     &      * (3.d0*x2**2 + 2.d0*x2 - 14.d0)
!
      return
