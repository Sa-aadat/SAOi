...
!----------------------------------------------------------------------!
      ...
      double precision x(n), gf(n), gc(*), x1, x2
!
      x1 = x(1)
      x2 = x(2)
!
      gf(1) = -2.d0*(1.5d0 - x1*(1.d0 - x2))*(1.d0 - x2)
     &      - 2.d0*(2.25d0 - x1*(1.d0 - x2**2))*(1.d0 - x2**2)
     &      - 2.d0*(2.625d0 - x1*(1.d0 - x2**3))*(1.d0 - x2**3)
      gf(2) = 2.d0*(1.5d0 - x1*(1.d0 - x2))*x1
     &      + 2.d0*(2.25d0 - x1*(1.d0 - x2**2))*2.d0*x1*x2
     &      + 2.d0*(2.625d0 - x1*(1.d0 - x2**3))*3.d0*x1*x2**2
!
      return
