...
!
      if (dabs(x2).le.0.5d0) then
        gc(1,1) = -6.d0/4.d0*x1 - 1.d0/4.d0*x2 -1.d0/2.d0   
        gc(1,2) =  - 1.d0/4.d0*x1 -  8.d0/ 3.d0*x2 + 1.d0/3.d0       
!        
      elseif (x2.lt.-0.5d0) then
        gc(1,1) = -6.d0/4.d0*x1 - 1.d0/4.d0*x2 -1.d0/2.d0        
        gc(1,2) =  - 1.d0/4.d0*x1 - 2.d0/3.d0*x2 + 4.d0/3.d0    
!     
      elseif (x2.gt. 0.5d0) then
        gc(1,1) = -6.d0/4.d0*x1 - 1.d0/4.d0*x2 -1.d0/2.d0
        gc(1,2) =  - 1.d0/4.d0*x1 - 2.d0*x2
     &         
      endif
!
      return
