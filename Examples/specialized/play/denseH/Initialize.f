...
!
! the Hessian of the Lagrangian of this problem is dense, due
!    to the contributions of both f and the single constraint c.
!    For the sake of quick testing, the number of design variables
!    in the test bed is only 500,000, but the true test uses
!    10,000,000 design variables
!
      iprint         =  2          !  
!
      n              =  50000      !  the number of design variables
      ni             =  1          !  the number of inequality constraints
!
      do i = 1,n
        x(i)         =  0.5d0      !  the starting point
      enddo
!
      do i = 1,n
...
!
      ...
      enddo
!
      cname1 = 'DENSE-H'           ! problem name; max 24 characters
!
!
