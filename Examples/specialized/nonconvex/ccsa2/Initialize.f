...
!
      n              =  200         !  the number of design variables
!      
...
!
      xtol           =  5.d-4    ! specify the x-tolerance (Euclidian norm)
...
!     biglam         =  1.d0     ! upper bound on the dual variables
      atol1          = -1.d3     ! minimum approx objective curvatures
      btol1          = -1.d3     ! minimum approx constraint curvatures
      ifalk          =  1        ! 0 = nonlinear / 1 = QP
!
