...
!
      ...
      ni             =  5        !  the number of inequality constraints
...
!
      do i=1,n
       x_lower(i)    =  -0.2d0   !  the lower bounds
       x_upper(i)    =   0.2d0   !  the upper bounds
      enddo
!
      cname1 = '2-BAR-DEFAULT'   ! problem name; max 24 characters
!    
!
!
...
!     subsolver      =  5        ! specify the solver for the subproblems
