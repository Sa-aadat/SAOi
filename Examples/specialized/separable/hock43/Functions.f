...
!
      f=x(1)**2+x(2)**2+2.d0*x(3)**2+x(4)**2-5.d0*x(1)-5.d0*x(2)-21.d0 
     &               *x(3)+7.d0*x(4)   
!
      c(1)=x(1)**2+x(2)**2+x(3)**2+x(4)**2+x(1)-x(2)+x(3)-x(4)-8.d0    
      c(2)=x(1)**2+2.d0*x(2)**2+x(3)**2+2.d0*x(4)**2-x(1)-x(4)-10.d0  
      c(3)=2.d0*x(1)**2+x(2)**2+x(3)**2+2.d0*x(1)-x(2)-x(4)-5.d0
!
      return
