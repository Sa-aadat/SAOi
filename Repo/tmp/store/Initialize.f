...
!
      ...
      ni               =  n/2+1      !  the number of inequality constraints
      ne               =  n/2
!
...
!
      tmp              = dble(n)*dble(ni+ne)*6.d0/(4.d0*dble(nseg)+2.d0) ! a cheap trick to overcome the need for long integers
!
      nnz              =  int(tmp)   !  the number of non-zero terms in gc
